...
public class Server {
	...
	private void startManagers() {
		...
		//*******PARTH ************//
		for (NodeDesc nodeDesc : conf.getNearest().getNearestNodes().values()) {
			ElectionManager.getInstance().addConnectToThisNode(nodeDesc.getNodeId(), nodeDesc.getHost(), nodeDesc.getMgmtPort());
			}
